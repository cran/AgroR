  ...
  { cat(green(bold("-----------------------------------------------------------------\n")))
    ...
    {cat(green(bold("\n-----------------------------------------------------------------\n")))
      ...
      if(quali[i]==TRUE){
        ## Tukey
        if(mcomp=="tukey"){
          letra <- TUKEY(resp, fatores[,i], anava$Df[5],anava$`Mean Sq`[5], alpha=alpha.t)
        ...
        if(mcomp=="lsd"){
          letra <- LSD(resp, fatores[,i], anava$Df[5],anava$`Mean Sq`[5],alpha=alpha.t)
          letra1 <- letra$groups; colnames(letra1)=c("resp","groups")
          if(transf !=1){letra1$respo=tapply(response,fatores[,i],mean, na.rm=TRUE)[rownames(letra1)]}}
        if (mcomp == "sk"){
    ...
    if(quali[1]==TRUE & quali[2]==TRUE){
      if (mcomp == "tukey"){
        ...
        for (i in 1:nv2) {
          ...
          tukey=TUKEY(respi,trati,anava$Df[5],anava$`Mean Sq`[5],alpha.t)
      ...
      if (mcomp == "duncan"){
        ...
        for (i in 1:nv2) {
          trati=fatores[, 1][Fator2 == lf2[i]]
          respi=resp[Fator2 == lf2[i]]
          duncan=duncan(respi,trati,anava$Df[5],anava$`Mean Sq`[5],alpha.t)
      ...
      if (mcomp == "lsd"){
        ...
        for (i in 1:nv2) {
          trati=fatores[, 1][Fator2 == lf2[i]]
          respi=resp[Fator2 == lf2[i]]
          lsd=LSD(respi,trati,anava$Df[5],anava$`Mean Sq`[5],alpha.t)
