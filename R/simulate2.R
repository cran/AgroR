...
#'   }
#' @keywords datasets
#' @seealso \link{cloro}, \link{enxofre}, \link{laranja}, \link{mirtilo}, \link{pomegranate}, \link{porco}, \link{sensorial}, \link{simulate1}, \link{simulate3}, \link{tomate}, \link{weather}
#' @examples
#' data(simulate2)
#' attach(simulate2)
"simulate2"
